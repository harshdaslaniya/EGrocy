...
function CustomerLogin(props) {
  ...
  const onClick =()=>{
console.log(user);
    axios.post('http://localhost:8000/customer/login', user,{ withCredentials: true })
      .then(response => {
            ...
            <div className="card-body  text-center">
              <div className="mb-md-5 mt-md-4 pb-5">
                ...
                <div className="form-outline form-white mb-4">
                  ...
                  <button className="btn btn-outline-light btn-lg px-5" onClick={onClick} type="button">Login</button>
